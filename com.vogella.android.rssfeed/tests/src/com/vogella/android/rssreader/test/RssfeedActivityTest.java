...
public class RssfeedActivityTest extends ActivityInstrumentationTestCase2<RssfeedActivity> {
	...
	public void testListPositionSaved() throws Exception {
		...
		getInstrumentation().runOnMainSync(new Runnable() {
			@Override public void run() {
				...
				assertEquals(listFragment.getSelectedItemPosition(), mListFragment.getSelectedItemPosition());
			}
		});
